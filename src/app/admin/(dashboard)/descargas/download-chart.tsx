...
export function DownloadChart({ daily, weekly, monthly }: Props) {
  ...
  return <section className="rounded-2xl border border-[var(--pos-border)] bg-[var(--pos-surface)] p-5 shadow-sm">
    ...
    <div className="mt-6 h-80 w-full min-w-0" aria-label={`Gráfico de descargas ${views[view].label.toLowerCase()}`}>
      {mounted ? <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={320}>
