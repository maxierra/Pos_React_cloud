...
export function PosClient({ products, business, cashOpen = false }: { products: PosProduct[]; business: PosBusinessInfo; cashOpen?: boolean }) {
  ...
  const onConfirmPayment = React.useCallback(
    ...
    [business, cart, closePayment, startTransition]
  );
